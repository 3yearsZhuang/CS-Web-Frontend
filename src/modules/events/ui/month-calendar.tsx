...
export function MonthCalendar({ events }: MonthCalendarProps) {
  ...
  const monthLabelsCn = [t('monthJan'), t('monthFeb'), t('monthMar'), t('monthApr'), t('monthMay'), t('monthJun'), t('monthJul'), t('monthAug'), t('monthSep'), t('monthOct'), t('monthNov'), t('monthDec')];
