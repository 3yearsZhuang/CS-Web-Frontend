...
import { seedEventsIfEmpty, seedCommunityCategoriesIfEmpty } from '../seeds/seeds';
...
export { initCommunitySchema } from './community-schema';
...
import { initCommunitySchema } from './community-schema';
...
export function initSchema(db: DB): void {
  ...
  seedCommunityCategoriesIfEmpty(db);
