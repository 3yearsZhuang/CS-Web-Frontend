...
export const PERMISSION_MODULES: PermissionModule[] = [
  {
    ...
    label: '社区管理',
    permissions: [
      { key: 'community.topic.update', label: '编辑任意主题', description: '修改其他用户发布的主题内容' },
      { key: 'community.topic.delete', label: '硬删除主题', description: '永久删除主题（不可恢复）' },
      { key: 'community.topic.hide', label: '隐藏主题', description: '将主题标记为隐藏，前台不展示' },
      { key: 'community.topic.restore', label: '恢复主题', description: '取消隐藏状态' },
      { key: 'community.topic.pin', label: '置顶主题', description: '切换主题置顶状态' },
      { key: 'community.topic.feature', label: '加精主题', description: '切换主题精华状态' },
      { key: 'community.reply.update', label: '编辑任意回复', description: '修改其他用户的回复内容' },
      { key: 'community.reply.delete', label: '硬删除回复', description: '永久删除回复' },
      { key: 'community.reply.hide', label: '隐藏回复', description: '将回复标记为隐藏' },
      { key: 'community.reply.restore', label: '恢复回复', description: '取消回复隐藏状态' },
      { key: 'community.category.create', label: '创建版块', description: '新增社区分类' },
      { key: 'community.category.update', label: '编辑版块', description: '修改分类名称、描述、排序' },
      { key: 'community.category.delete', label: '删除版块', description: '删除社区分类' },
    ],
  },
  {
    key: 'exam',
  ...
  },
  {
    ...
    label: '社区管理',
    permissions: [
      { key: 'community.post.update', label: '编辑任意文章', description: '修改其他用户的社区文章' },
      { key: 'community.post.publish', label: '发布审核', description: '审核并发布待发布文章' },
      { key: 'community.post.archive', label: '归档文章', description: '将文章标记为归档状态' },
      { key: 'community.post.delete', label: '删除文章', description: '永久删除社区文章' },
    ],
  },
  {
    key: 'resource',
