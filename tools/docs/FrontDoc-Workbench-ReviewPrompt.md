...
> 最后更新：2026-08-20｜类型：how-to + work
> 更新人：3yearsZ
> 受众：前端贡献者 / reviewer（工作台全链路，含 BFF 与后端 FastAPI 检查点）
> Source of truth：本文件（工作台代码审查 prompt 模板唯一权威；源代码现状以 `src/modules/workbench/` 为准）
> 关联：工作台实现见 [FrontDoc-01-Arch.md](FrontDoc-01-Arch.md)；后端契约见根 [docs/RootDoc-ModuleMap.md](../../../docs/RootDoc-ModuleMap.md)
