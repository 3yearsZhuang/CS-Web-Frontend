...
本文件记录 FZTBU CS 项目的所有显式版本变更。

格式遵循 [Keep a Changelog](https://keepachangelog.com/zh-CN/1.1.0/)，版本号遵循 [Semantic Versioning](https://semver.org/lang/zh-CN/)。

> ℹ️ 自 2026-08-05 起，**细粒度变更记录与待办条目已统一迁移至 `docs/`**：
> - 已完成变更 → [`项目演变历史.md`](../docs/项目演变历史.md)（按日期 + 项目编号归类）
...
详见 `docs/项目演变历史.md`（2026-08-07 起条目）。

## [0.9.7] - 2026-08-06

详见 `docs/项目演变历史.md`（2026-08-06 起条目）。
...
详见 `docs/项目演变历史.md`（2026-07-31 0.9.1 预发布条目：SLO + alerting + load test + restore drill + runbook + rollback + CI 加固 + EX-1 风险接受 + ADR-018）。
